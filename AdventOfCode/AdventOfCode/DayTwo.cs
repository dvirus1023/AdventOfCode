...
namespace AdventOfCode
{
    ...
    public class Box
    {
        ...
        public int Height { get
            {
                return Convert.ToInt32(Dimensions.Split('x')[2]);
            }
        }
        public int SmallestArea { get
            {
                return Math.Min((Height * Width),Math.Min((Height * Length),(Length * Width)));
            }
        }
